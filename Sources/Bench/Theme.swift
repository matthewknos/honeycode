...
enum Theme {
    ...
    static var canvas: Color { Color(nsColor: .benchCanvas) }

    /// Raised surfaces — the composer, the palette. White on the warm ground.
    static var surface: Color { Color(nsColor: .benchSurface) }
    ...
    static var codeGround: Color { Color(nsColor: .benchCodeGround) }
}
...
extension NSColor {
    static let benchCanvas = NSColor(name: "benchCanvas") { appearance in
    ...
    static let benchSurface = NSColor(name: "benchSurface") { appearance in
        appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
    ...
    static let benchCodeGround = NSColor(name: "benchCodeGround") { appearance in
        appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
    ...
    static let benchDiffAdd = NSColor(name: "benchDiffAdd") { appearance in
        appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
            ? NSColor(srgbRed: 0.353, green: 0.816, blue: 0.451, alpha: 1)
            : NSColor(srgbRed: 0.106, green: 0.451, blue: 0.196, alpha: 1)
    }

    static let benchDiffDel = NSColor(name: "benchDiffDel") { appearance in
        appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
...
extension Color {
    ...
    static var diffAddText: Color { Color(nsColor: .benchDiffAdd) }
    static var diffDelText: Color { Color(nsColor: .benchDiffDel) }
}
